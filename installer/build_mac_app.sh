...
#   ./installer/build_mac_app.sh 3.14.0            # specify version
#
...
# Sub-packages (tools, channels, bundled_skills, ui, plugins)
for pkg in tools channels bundled_skills ui plugins; do
