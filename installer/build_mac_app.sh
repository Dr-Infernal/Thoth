...
# Sub-packages (tools, channels, bundled_skills, tool_guides, ui, plugins, designer, scripts)
for pkg in tools channels bundled_skills tool_guides ui plugins designer scripts; do
